'''This script gets snow depth for stations_to_load and loads them into weather_snwd,
...
# Function gets the data and inserts it into weather_snwd, 1000 at a time
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            for result in j['results']:
                try:
                    insert_sql = "INSERT INTO weather.weather_snwd (station_id, date, country_code, region, weather_jsonb) VALUES (%s,%s,%s,%s,%s) ON CONFLICT (station_id, date) DO UPDATE SET country_code=%s, region=%s, weather_jsonb=%s"
