'''This script gets maximum temperatures for stations_to_load and loads them into weather_tmax,
...
# Function gets the data and inserts it into weather_tmax, 1000 at a time
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            for result in j['results']:
                try:
                    insert_sql = "INSERT INTO weather.weather_tmax (station_id, date, country_code, region, weather_jsonb) VALUES (%s,%s,%s,%s,%s) ON CONFLICT (station_id, date) DO UPDATE SET country_code=%s, region=%s, weather_jsonb=%s"
...
def get_weather():
    ...
    # get weather data and load into weather_tmax
    api_calls = 0
