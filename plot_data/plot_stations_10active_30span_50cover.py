...
df = pd.read_csv('/Users/chuckschultz/climaster/CSVs/stations_10active_30span_50cover.csv')
...
ax.set_title('Weather Stations\n10_active_30span_50cover')
fig.savefig("stations_10active_30span_50cover.png")
plt.show()